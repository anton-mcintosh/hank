                ...
                "messages": [
                    {
                        "role": "user",
                        "content": [
                            {"type": "text", "text": "Extract the VIN number from this door placard image. Only return the VIN, nothing else."},
                ...
                "messages": [
                    {
                        "role": "user",
                        "content": [
                            {"type": "text", "text": "Read the odometer value from this image. Return only the numeric value in miles, no text."},
                            {"type": "image_url", "image_url": {"url": f"data:image/jpeg;base64,{image_content}"}}
                        ]
                    }
                ],
